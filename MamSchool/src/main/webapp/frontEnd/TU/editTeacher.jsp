                    ...
                    %>
                        <form action="${pageContext.request.contextPath}/TeacherServlet" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nip" name="nis" value="<%= teacher.getNip() %>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" value="<%= teacher.getDateOfBirth() %>" required>
                            </div>
