<%-- 
    Document   : listKelasRapot
    Created on : 27 Dec 2024, 19.18.43
    Author     : luthfiah
--%>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="form-container">
                <%
                    List<Classes> classes = (List<Classes>) request.getSession().getAttribute("allKelas");

                %>
                <form  action="${pageContext.request.contextPath}/rapotServlet" method="post">
                    <!-- Input Action -->
