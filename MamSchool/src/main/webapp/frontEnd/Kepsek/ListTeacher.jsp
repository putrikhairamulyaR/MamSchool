<%-- 
    ...
    Created on : 31 Dec 2024, 14.50.09
    Author     : Royal
--%>
        ...
        <nav id="sidebar" class="border-end vh-100 shadow">
            <div class="p-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/ListTeacherServlet">
                            <i data-feather="users" class="align-middle"></i>
        ...
        <div id="content" class="flex-grow-1">
            ...
            <div class="p-3">
                <div class="table-container">
                    <h3>Daftar Guru</h3>
                    <form action="${pageContext.request.contextPath}/ListTeacherServlet" method="get" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="subject" id="subject" class="form-select">
                                    ...
                                    <c:forEach var="subjectOption" items="${subjects}">
                                        <option value="${subjectOption}" ${param.subject == subjectOption ? 'selected' : ''}>${subjectOption}</option>
                                    </c:forEach>
                                </select>
