<%-- 
    ...
    Created on : 31 Dec 2024, 11.04.31
    Author     : Royal
--%>
        ...
        <nav id="sidebar" class="border-end vh-100 shadow">
            <div class="p-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/ListStudentServlet">
        ...
        <div id="content" class="flex-grow-1">
            ...
            <div class="p-3">
                <div class="table-container">
                    <h3>Daftar Siswa</h3>
                    <form action="${pageContext.request.contextPath}/ListStudentServlet" method="get" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
